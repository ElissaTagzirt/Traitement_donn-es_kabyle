...
def main():
    PDF_INPUT_DIR = "./PDFs/imp/without_tables"         # Répertoire contenant vos PDF
    MD_OUTPUT_DIR = "./Markdown/without_tables"  # Répertoire de sortie pour les fichiers .md
    ...
    for pdf_name in pdf_files:
        ...
        # Ajustez header_cutoff et col_split_x selon vos besoins.
        process_pdf(pdf_path, output_md, header_cutoff=100, col_split_x=None)
